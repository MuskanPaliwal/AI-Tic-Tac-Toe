...
# tic-tac-toe-minimax
An implementation of Minimax AI Algorithm on Tic-Tac-Toe (or Noughts and Crosses) game. Try it: [Tic-tac-toe - Minimax](https://github.com/MuskanPaliwal/AI_Tic-Tac-Toe)
<p align="center">
